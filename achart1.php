...
<h4 style="text-align:center;">CITY WISE SALES</h4>
<form name="f" action="achart1.php" method="post">
<center>
Select Product
<select name="pid">
<?php
...
<?php
	...
	extract($_POST);
$result = mysqli_query($link, "select city,count(*) as countt from pur p,newuser n where p.userid=n.userid and p.pid='$pid' group by country,city");
...
<script type="text/javascript">
 ...
 <?php 
	...
	echo "['".$row['city']."',".$row['countt']."],";
	}
?> 
]);

var options = {
	title: 'Sales of Product according to Cities',
	pieHole: 0.5,
	pieSliceTextStyle: {
	color: 'black',
	},
