...
$rs = mysqli_query($link, "select p.dt,p.pid,cname,brand,pname,price,pimage,delivery from pur p,product o where o.pid=p.pid and p.userid='$_SESSION[userid]' order by p.dt desc") or die(mysqli_error($link));
